		...
		<label class="form-label inline-flex items-center gap-1" for="tcx-input">
			...
			<span class="group relative z-[100] ml-1">
				<button
					...
					aria-label="What is a GPX or TCX?">?</button
				>
				<span
					id="tcx-tooltip"
					role="tooltip"
					class="pointer-events-none absolute top-full left-0 z-[101] mt-1 w-64 rounded-md border border-border bg-white/95 p-2 text-xs text-foreground opacity-0 shadow-xl backdrop-blur-sm duration-150 group-focus-within:opacity-100 group-hover:opacity-100 [[data-theme=dark]_&]:bg-zinc-900/95"
				>
					<strong>What is a GPX or TCX?</strong> Activity files with GPS and workout stats.
					<strong class="text-blue-600 [[data-theme=dark]_&]:text-blue-400"
						>GPX (recommended)</strong
					>
					and TCX can be exported from apps like Strava, Garmin Connect, Wahoo, or Polar.
					<em>GPX is preferred for better elevation data and compatibility.</em>
				</span>
			</span>
		</label>
		<div class="relative">
