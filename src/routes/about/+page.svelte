...
<section class="mx-auto max-w-prose">
	...
	<p class="mb-3">
		...
		workouts into clean, shareable visuals by extracting key metrics from your GPX files and
	...
	<p class="mb-3">
		Upload a <code>.gpx</code> activity file and choose which stats to show (for example: distance, moving
	...
	<ol class="mb-3 list-decimal space-y-1 pl-5">
		<li>Upload your image and <code>.gpx</code> file.</li>
	...
	<h3 class="mb-2 text-base font-semibold tracking-tight">What is a GPX file?</h3>
	<p class="mb-3">
		A <code>.gpx</code> (GPS Exchange Format) file is a widely-used workout data format containing GPS
		tracks and activity stats like distance, time, pace/speed, and elevation. Many fitness apps and devices
		can export your activity as GPX.
	</p>

	<h3 class="mb-2 text-base font-semibold tracking-tight">Where to get a GPX</h3>
	<ul class="mb-3 list-disc space-y-1 pl-5">
		<li>
			<strong>Strava</strong>: Open an activity → <em>...</em> menu → <em>Export GPX</em>.
		</li>
		<li>
			<strong>Garmin Connect</strong>: Activity page → <em>Gear</em> icon → <em>Export as GPX</em>.
		</li>
		<li>
	...
	<ul class="mb-3 list-disc space-y-1 pl-5">
		<li>A valid <code>.gpx</code> activity file exported from your fitness tracker/app.</li>
		<li>
